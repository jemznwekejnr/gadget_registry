...
<head>
	...
	<meta name="description" content="JARVIS">
	<meta property="og:title" content="JARVIS">
	<meta property="og:description" content="JARVIS">
	<meta property="og:image" content="{{ asset('assets/images/jarvis-logo.png') }}">
	<meta name="format-detection" content="telephone=no">
	
	<!-- PAGE TITLE HERE -->
	<title>JARVIS</title>
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/jarvis-logo.png') }}">
