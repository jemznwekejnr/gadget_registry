				...
				<div class="col-xl-12 col-lg-12">
					<div class="card">
						...
						<div class="col-xl-12">
							<div class="row">
								<div class="col-xl-11">
									<h4 class="card-title">My Searched Device</h4>
								</div>
								<div class="col-xl-1">
							...
							<div class="table-responsive">
								<table class="table-stripped table" id="example">
									...
									<tbody>
								        ...
								        @php $gadget = app\Http\Controllers\Controller::getdeviceinfo($history->deviceid) @endphp
								        <td>{{ $gadget[0]->type }}</td>
								        <td>{{ $gadget[0]->manufacturer }}</td>
								        <td>{{ $gadget[0]->model }}</td>
								        <td>{{ $gadget[0]->year }}</td>
								        <td>{{ $gadget[0]->created_at }}</td>
								        <td>{{ $gadget[0]->status }}</td>
