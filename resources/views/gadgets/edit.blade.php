...
<div class="page-titles">
	<ol class="breadcrumb">
		<li><h5 class="bc-title">Jarvis</h5></li>
		...
		<li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Device</a></li>
	</ol>
</div>
								...
								<form action="/gadgets/update" method="post" id="updategadget" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-xl-3 col-md-3">
											<div class="mb-3">
												...
												<select name="type" class="form-control input-rounded" id="types">
													<option value="{{ $gadgets[0]->type }}">{{ app\Http\Controllers\Controller::typename($gadgets[0]->type) }}</option>
										...
										<div class="col-xl-3 col-md-3">
											<div class="mb-3">
												...
												<select name="manufacturer" class="form-control input-rounded" id="manufacturers">
													<option value="{{ $gadgets[0]->manufacturer }}">{{ app\Http\Controllers\Controller::manufacturername($gadgets[0]->manufacturer) }}</option>
												</select>
											</div>
										</div>
										...
										<div class="col-xl-2 col-md-2">
											<div class="mb-3">
												...
												<input type="text" class="form-control input-rounded" name="serialno" id="serialno" placeholder="Serial No" value="{{ $gadgets[0]->serialno }}">
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-12 col-md-12" style="text-align: right;">
											<div class="mb-3">
												<button type="submit" id="button" class="btn btn-primary btn-md btn-rounded">Update</button>
